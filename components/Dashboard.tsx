    ...
    <div className="p-8 lg:p-12 w-full space-y-10 animate-in fade-in slide-in-from-top-4 duration-700">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 group">
          ...
          <div>
            ...
            <p className="text-4xl font-black text-slate-900">{activeSitesCount}</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2 bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden flex flex-col hover:shadow-2xl transition-all duration-500">
          ...
          <div className="flex-1 min-h-[420px] p-8 flex flex-col gap-4">
             {sites.length === 0 ? (
        ...
        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8 hover:shadow-2xl transition-all duration-500 flex flex-col">
          <div className="flex items-center justify-between mb-8">
            <h3 className="font-black text-slate-900 text-2xl tracking-tight">À faire</h3>
